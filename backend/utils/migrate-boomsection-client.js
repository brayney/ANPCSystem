...
async function migrateBoomSectionClient() {
  try {
    console.log('🔄 Connecting to MongoDB...');
    await mongoose.connect(process.env.MONGODB_URI);
    console.log('✅ Connected to MongoDB');

    console.log('🔄 Updating all boom sections client to "-"...');
    const result = await BoomSection.updateMany(
